...
import com.pfyuit.myjavaee.service.database.mybatis.ApplyService;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "classpath*:/database/mybatis/myjavaee-database-mybatis-test.xml" })
