...
/**
 * Operations for Java reflection.
 * @author yupengfei
 */
public class ReflectTest {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchFieldException,
		...
		Class<?> clazz = loader.loadClass("com.pfyuit.myjavase.java.lang.reflect.User");
		User user = (User) clazz.newInstance();
		user.setName("pfyuit");
		user.setSex("male");

		testField(clazz, user);
		testMethod(clazz, user);
		testConstruction(clazz);
	}

	private static void testConstruction(Class<?> clazz) throws NoSuchMethodException, InstantiationException, IllegalAccessException,
	...
	private static void testMethod(Class<?> clazz, User user) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
	...
	private static void testField(Class<?> clazz, User user) throws NoSuchFieldException, IllegalAccessException {
...
/**
 * Custom class to test Java reflection.
 * @author yupengfei
 */
class User {
